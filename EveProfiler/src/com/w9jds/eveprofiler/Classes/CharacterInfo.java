...
public class CharacterInfo implements Serializable {
	...
	public void CombineSheet(CharacterInfo Info2) {
		...
		if(this.characterID == null)
			this.characterID = Info2.getCharacterID();
		if(this.corporationName == null)
			this.corporationName = Info2.getCorporationName();
		if(this.corporationID == null)
			this.corporationID = Info2.getCorporationID();
		if(this.allianceName == null)
			this.allianceName = Info2.getAllianceName();
		if(this.allianceID == null)
			this.allianceID = Info2.getAllianceID();
		if(this.DateOfBirth == null)
			this.DateOfBirth = Info2.getDateOfBirth();
		if(this.Race == null)
			this.Race = Info2.getRace();
		if(this.BloodLine == null)
			this.BloodLine = Info2.getBloodLine();
		if(this.Ancestry == null)
			this.Ancestry = Info2.getAncestry();
		if(this.Gender == null)
			this.Gender = Info2.getGender();
		if(this.CloneName == null)
			this.CloneName = Info2.getCloneName();
		if(this.CloneSkillPoints == null)
			this.CloneSkillPoints = Info2.getCloneSkillPoints();
		if(this.WalletBalance == null)
			this.WalletBalance = Info2.getWalletBalance();
		if(this.Intelligence == null)
			this.Intelligence = Info2.getIntelligence();
		if(this.Memory == null)
			this.Memory = Info2.getMemory();
		if(this.Charisma == null)
			this.Charisma = Info2.getCharisma();
		if(this.Perception == null)
			this.Perception = Info2.getPerception();
		if(this.Willpower == null)
			this.Willpower = Info2.getWillpower();
		if(this.Skills == null)
