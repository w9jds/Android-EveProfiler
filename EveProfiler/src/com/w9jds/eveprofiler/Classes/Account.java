...
public class Account implements Parcelable {
    ...
    public ArrayList<CharacterInfo> getCharacters() { return this.Characters; }
    public void setCharacters(ArrayList<CharacterInfo> Characters) { this.Characters = Characters; }
